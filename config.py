...
def get_train_params():
    ...
    parser.add_argument('--dataset_path', type=str, default="./datasets/screw", help='inference dataset path')
    ...
    parser.add_argument('--epoch', type=int, default=100, help='training epochs')
    parser.add_argument('--batch_size', type=int, default=4, help='inference mini batch size')
    parser.add_argument('--lr', type=float, default=0.00003, help='training learning rate')
    ...
    parser.add_argument('--entropy_loss_weight', type=float, default=0.0002, help='loss parameter')
    parser.add_argument('--device', type=str, default="cuda:0", help='training device')
    parser.add_argument('--model_path', type=str, default="./weight/MemAE_ckpt.pt", help='checkpoint name')
    parser.add_argument('--save_ckpt', action="store_true", help='saving checkpoint')
